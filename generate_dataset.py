...
def count():
    sim_frame = pd.read_csv(file_name, sep='\t')
    print(len(sim_frame))
    print(sim_frame.head(10))
    print(sim_frame["plateau_pop"].value_counts(bins=10))
    print(sim_frame[sim_frame["area_length_x"]==100.0].describe()['death_r'])
    print(sim_frame[sim_frame["plateau_pop"]>1]['area_length_x'].value_counts())
